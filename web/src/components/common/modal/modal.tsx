...
const Modal = ({ children, state }: Props) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="max-w-[100%] max-h-[80%] overflow-y-auto relative bg-gray-100 rounded-lg isolate dark:bg-gray-800">
        <header className="w-full flex justify-between sticky top-0 items-center pt-2 px-4 z-10 bg-gray-100 dark:bg-gray-800">
