      ...
      {isOpen &&
        createPortal(
          <OutsideAlerter exceptElement={id} onEvent={() => setOpen(false)}>
            ...
            >
              <div
                className={`flex flex-col border border-gray-300 max-h-[420px] overflow-auto w-96 bg-white shadow-sm rounded-md isolate`}
              >
                <div
                  className={`flex items-center gap-4 px-4 pt-2 sticky top-0 bg-white z-1`}
                >
